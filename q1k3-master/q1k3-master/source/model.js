...
model_init = (data, sx = 1, sy = 1, sz = 1) => {
    ...
    let before_r_num_verts = r_num_verts;
    ...
    let inc_r_num_verts = r_num_verts - before_r_num_verts;
    console.log(" model_init(): inc_verts="+inc_r_num_verts+" model.vertices.length="+num_vertices+", model.num_indices="+num_indices+", model.num_frames="+num_frames);

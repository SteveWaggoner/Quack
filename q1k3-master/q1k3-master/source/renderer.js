...
r_vertex_attrib = (shader_program, attrib_name, count, vertex_size, offset) => {
   ...
   // console.log(" r_vertex_attrib "+shader_program+" "+attrib_name+" "+count+" "+vertex_size+" "+offset+" ==> "+location);
...
r_end_frame = () => {
 ...
 //   console.log(" r_end_frame r_camera.x="+r_camera.x);
 //   console.log(" r_end_frame r_camera.y="+r_camera.y);
 //   console.log(" r_end_frame r_camera.z="+r_camera.z);
 //   console.log(" r_end_frame r_camera_yaw="+r_camera_yaw);
 //   console.log(" r_end_frame r_camera_pitch="+r_camera_pitch);
 //   console.log(" r_end_frame r_light_buffer="+r_light_buffer);
	...
	for (let c of r_draw_calls) {
      ...
      //  console.log(" r_end_frame(): c="+c);
      //  console.log(" r_end_frame(): vo="+vo);
      //  console.log(" r_end_frame(): p1="+c[6]+" p2="+c[9]);
...
r_submit_buffer = () => {
   console.log("r_submit_buffer(): r_num_verts = "+r_num_verts);
